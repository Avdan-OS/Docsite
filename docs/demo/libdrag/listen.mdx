...
This function also executes realtime drag functions for `currentTarget` and `target` Object every move. This functions are stored in `dragList`, that you can [get](get) with a function.