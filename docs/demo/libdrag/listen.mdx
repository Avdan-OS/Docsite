...
This function also executes while-drag functions for `currentTarget` and `target` Object. This functions are stored in `dragList`, that you can [get](get) with a function.