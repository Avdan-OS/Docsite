...
```
You can modify it and send it as an argument.

For more details check the template sections in the demo library.
...
`extraClass` is an array of strings. All strings will be added to the generated window as classes.
```js
...
It allows us to overpass cloning limitations and make windows dynamic.
...
For more info about how to create an app, go to the template sections in the demo library.